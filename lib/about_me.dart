          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(fit: BoxFit.fill, image: AssetImage('images/Bregas.jpg'),),
              ),
            ),
            Text('Bregas Ardianto', style: TextStyle(color: Colors.black, fontSize: 24.0),),
            Text('bregas@undiksha.ac.id', style: TextStyle(color: Colors.black, fontSize: 14.0),),
            ...
            Row(
                children: <Widget>[
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Icon(Icons.my_location, size: 50, color: Colors.red,),
                          Container(
                            child: Text('Seririt', style: TextStyle(color: Colors.white, fontSize: 16.0),),
                  ...
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Container(
                            child: Text('L. Karang Sari', style: TextStyle(color: Colors.white, fontSize: 16.0),),
                            padding: EdgeInsets.all(5),
                            decoration: BoxDecoration(
                              color: Colors.green,
                              borderRadius: BorderRadius.circular(20),
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          IconButton(
                            icon: Icon(Icons.photo_album, color: Colors.red, size: 30),
                            onPressed: () {
                              Navigator.push(
                                context,
                  ...
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Icon(Icons.school, size: 50, color: Colors.red),
                          Container(
